...
results_folder = "F:/Daniel/lookback_matching/results_only_dd_vars"
...
cols_to_keep = c(c(1:3),c(345:1026))
cols_to_round = colnames(train_matched)[c(c(2:3),c(345:1026))]
train_matched[cols_to_round] = lapply(train_matched[cols_to_round], function(x) round(x, 0))
...
train_matched = train_matched[,cols_to_keep]
train_unmatched_df = train_unmatched_df[,cols_to_keep]
test_dataset = test_dataset[,cols_to_keep]
test_matched_dataset = test_matched_dataset[,cols_to_keep]
test_smote_dataset = test_smote_dataset[,cols_to_keep]
test_weighted_dataset = test_weighted_dataset[,cols_to_keep]
smote_1000_dataset = smote_1000_dataset[,cols_to_keep]
smote_10000_dataset = smote_10000_dataset[,cols_to_keep]
smote_rand_dataset = smote_rand_dataset[,cols_to_keep]

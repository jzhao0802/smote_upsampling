...
test_dataset = makeClassifTask(id="test_dataset", data=test_dataset, 
                               target="label", positive=1)

test_smote_dataset = makeClassifTask(id="test_smote_dataset", data=test_smote_dataset, 
                                     target="label", positive=1)

smote_1000_dataset = makeClassifTask(id="smote_1000_dataset", data=smote_1000_dataset, 
                                     target="label", positive=1)

smote_10000_dataset = makeClassifTask(id="smote_10000_dataset", data=smote_10000_dataset, 
                                      target="label", positive=1)
